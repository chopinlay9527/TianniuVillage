...
const TEX = {
  ...
  terrain: {
    ...
    highland:     { tiles: ["t25"], tint: "rgba(115,115,100,0.30)" },// 高地(土加灰罩)
    mountain:     { tiles: ["t25"], tint: "rgba(100,100,115,0.48)",  // 山(土加岩灰罩+裂纹)
                    cracks: true, crackColor: "rgba(35,35,45,0.55)" },
  },

  // ---------- 资源物件 ----------
  tree: {
    tiles: ["t3", "t4", "t5", "f39"],        // 树（多格随机分布）
